...
class CFExperiment(Experiment):
    ...
    def _prepare_set(self, strmode, k, data):
        ...
        if strmode == '111':
            ...
            item_concepts_encode_file = open(
                item_concepts_encode_filename, 'w+')
            user_reviews_encode_file = open(user_reviews_encode_filename, 'w+')
            user_concepts_encode_file = open(
                user_concepts_encode_filename, 'w+')
            ...
            for x in self.iu_review_dict[items[i]]:
                ...
                if strmode == '111':
                    item_reviews_encode_file.write(
                        str(self.iu_review_dict[items[i]][x])+'\n')
                    item_concepts_encode_file.write(
                        str(self.iu_concept_dict[items[i]][x])+'\n')
                ...
                for y in self.ui_review_dict[x]:
                    ...
                    if strmode == '111':
                        user_reviews_encode_file.write(
                            str(self.ui_review_dict[x][y])+'\n')
                        user_concepts_encode_file.write(
                            str(self.ui_concept_dict[x][y])+'\n')
        ...
        for i in tqdm(range(num_batches+1)):
            ...
            '''if i<20:
               ...
               for j in range(bsz):
                    ...
                    #print('gen_sentences:'+str(new_sentence))
                    new_sentence= []
                    ...
                    #print('ref_sentences:'+str([new_sentence]))
                    #print('================================================================')
